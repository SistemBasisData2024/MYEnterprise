...
const links = [
  ...
  { name: "Inventory", href: "/dashboard/inventory", icon: TruckIcon },
  { name: "Employee", href: "/dashboard/employee", icon: UsersIcon },
  { name: "Project", href: "/dashboard/projects", icon: TableCellsIcon },
];
